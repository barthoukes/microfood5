...
import com.hha.service.DailyTransactionChecksumService
...
import com.hha.service.PrepareTransactionService
...
object GrpcServiceFactory
{
    ...
    fun createDailyTransactionChecksumService(): DailyTransactionChecksumService
    {
        val channel = getChannel()
        return DailyTransactionChecksumService(channel)
    }
    ...
    fun createStorePartService(): StorePartService
    {
        val channel = getChannel()
        return StorePartService(channel)
    }

    fun createStoreSmurfService(): StoreSmurfService
    {
        val channel = getChannel()
        return StoreSmurfService(channel)
    }
    ...
    fun createPrepareTransactionService(): PrepareTransactionService
    {
        val channel = getChannel()
        return PrepareTransactionService(channel)
    }
